...
$nama_siswa = $_POST['nama__lengkap']; 
$mata_kuliah = $_POST['mata__kuliah'];
$nilai_uts = $_POST['nilai__uts'];
$nilai_uas = $_POST['nilai__uas'];
$nilai_tugas = $_POST['nilai__tugas'];
$nim = $_POST['nim__'];
...
$ns1 = ['id'=>1,'nama'=>'Bagas','nim'=>'01101','matkul'=>'DDP','uts'=>30,'uas'=>40,'tugas'=>30,'total'=>100,'grade'=>'E','keterangan'=>'Sangat Kurang'];
$ns2 = ['id'=>2,'nama'=>'Dimas','nim'=>'01121','matkul'=>'Basis Data','uts'=>70,'uas'=>50,'tugas'=>68,'total'=>188,'grade'=>'C','keterangan'=>'Kurang'];
$ns3 = ['id'=>3,'nama'=>'Revan','nim'=>'01130','matkul'=>'Basis Data','uts'=>60,'uas'=>86,'tugas'=>80,'total'=>146,'grade'=>'B','keterangan'=>'Cukup'];
$ns4 = ['id'=>4,'nama'=>'Bambang','nim'=>'01134','matkul'=>'PWL','uts'=>90,'uas'=>91,'tugas'=>82,'total'=>263,'grade'=>'A','keterangan'=>'Lulus'];
...
?>
            <div class="col-4 mt-3">
                <div class="card ml-5" style="width: 17rem;">
                    <div class="card-header bg-warning text-white" style="font-weight: bold; font-size: 20px;">Range Nilai</div>
            ...
            <div class="col-4 mt-3">
                <div class="card" style="width: 18rem;">
                    <div class="card-header bg-success text-white" style="font-weight: bold; font-size: 20px;">Predikat</div>
                        <ul class="list-group list-group-flush">
...
<h3 style = "text-align : center; color : black;" >Daftar Nilai Siswa</h3>
